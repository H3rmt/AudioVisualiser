...
void drawSprite(TFT_eSprite &canvas, int approxBuffer[SAMPLES_USABLE], short streamBuffer[SAMPLES], int peakBuffer[SAMPLES_USABLE], uint8_t max_index_float, uint8_t max_index_actual, uint8_t max_index, u_int32_t streamBufferMax, u_int32_t floating_min, u_int32_t avg, u_int32_t floating_avg, bool off);